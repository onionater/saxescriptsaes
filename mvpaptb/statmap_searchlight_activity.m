function [subj] = statmap_searchlight(subj,data_patname,regsname,selname,new_map_patname, fs_args, extra_arg)
...
for v = 1:nVox
  ...
  %implement additional feature selection here (should be flexible enough
  %to do anova or activity, and rank or threshold based
  
  feature_select_within_searchlight_activity(subject, fs_args) 
