...
%check your SPM.mat for the order of your conditions to create the contrast
%below (not a real contrast just a relabeling of conditions)
...
%save the relevant structures for the subject
 save([mvpadir 'subjinfo_' task '_' runsincluded], 'boldnames', 'maskname', 'mvpa_mask_description', 'allconds_binarized', 'allconds_convolved',  'allcond_names','blocklabels', 'blocklabelscomb', 'runselectors', 'evenoddselectors', 'artselectors', 'restselectors', 'combselectors', 'stimselector','foldlabels', 'TR', 'subjvoxelcount', 'voxelcountlabel');
