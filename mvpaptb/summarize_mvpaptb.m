...
mkdir([rootdir 'mvpaptb/' mvparesults, subjectrange, '/specifics/']);
...
numDisc=length(ds);
        for d=1:numDisc
            ...
            templateDES=dir([rootdir subjectlist{1} '/' subjmvpa roilist{1} '*' desc '*classification.mat']); % to identify num of disc variants for the descrimination
