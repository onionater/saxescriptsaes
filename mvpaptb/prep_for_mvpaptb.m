...
ROISind={'ROI_RTPJ_tomloc','ROI_LTPJ_tomloc','ROI_RSTS_tomloc','ROI_LSTS_tomloc','ROI_PC_tomloc', 'ROI_MMPFC_tomloc', 'ROI_DMPFC_tomloc', 'ROI_rpSTS_BDbiomot', 'ROI_rFFA_kanparcelFaceObj_EmoBioLoc','ROI_lFFA_kanparcelFaceObj_EmoBioLoc', 'ROI_rSTS_kanparcelFaceObj_EmoBioLoc', 'ROI_lSTS_kanparcelFaceObj_EmoBioLoc', 'ROI_rOFA_kanparcelFaceObj_EmoBioLoc', 'ROI_lOFA_kanparcelFaceObj_EmoBioLoc', 'ROI_rLOC_foundObjFace_EmoBioLoc', 'ROI_lLOC_foundObjFace_EmoBioLoc'};
roi_descriptions_ind={'RTPJ_tomloc_ind', 'LTPJ_tomloc_ind', 'RSTS_tomloc_ind', 'LSTS_tomloc_ind', 'PC_tomloc_ind', 'MMPFC_tomloc_ind', 'DMPFC_tomloc_ind', 'rpSTS_BDbiomot_ind', 'rFFA_kanparcelFaceObj_EmoBioLoc','lFFA_kanparcelFaceObj_EmoBioLoc', 'rSTS_kanparcelFaceObj_EmoBioLoc', 'lSTS_kanparcelFaceObj_EmoBioLoc', 'rOFA_kanparcelFaceObj_EmoBioLoc', 'lOFA_kanparcelFaceObj_EmoBioLoc', 'rLOC_foundObjFace_EmoBioLoc', 'lLOC_foundObjFace_EmoBioLoc'};
...
%save the relevant structures for the subject
 save([mvpadir 'subjinfo'], 'boldnames', 'maskname', 'mvpa_mask_description', 'eightconds_binarized', 'eightconds_convolved',  'eightcond_names','blocklabels', 'blocklabelscomb', 'runselectors', 'evenoddselectors', 'artselectors', 'restselectors', 'combselectors', 'stimselector', 'contextselector', 'genderselector', 'foldlabels', 'TR', 'subjvoxelcount', 'voxelcountlabel');
 save([mvpadir 'discriminations'], 'alleight', 'faceVScontext', 'negVSpos', 'negfVSposf', 'negcVSposc', 'maleVSfemale', 'socialVSnonsoc','socialnVSsocialp', 'nonsocnVSnonsocp', 'malenVSmalep', 'femalenVSfemalep');
    end
clearvars 'boldnames' 'maskname' 'mvpa_mask_description' 'eightconds_binarized' 'eightconds_convolved' 'eightcond_names' 'blocklabels'  'blocklabelscomb'  'runselectors'  'evenoddselectors' 'artselectors' 'restselectors' 'combselectors' 'stimselector' 'contextselector' 'genderselector' 'foldlabels'
clearvars 'alleight' 'faceVScontext' 'negVSpos' 'negfVSposf' 'negcVSposc' 'maleVSfemale' 'socialVSnonsoc' 'socialnVSsocialp' 'nonsocnVSnonsocp' 'malenVSmalep' 'femalenVSfemalep'
end
